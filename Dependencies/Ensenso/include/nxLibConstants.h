...
static short const InvalidDisparityScaled = -32768; // Bit pattern 0x8000.
...
static short const NxLibInvalidDisparityScaled = -32768; // Bit pattern 0x8000.
...
NXLIB_ITEM(Debug);
NXLIB_ITEM(Level);
NXLIB_ITEM(BufferSize);        // Deprecated
NXLIB_ITEM(BufferCount);       // Deprecated
NXLIB_ITEM(StaticBufferCount); // Deprecated
NXLIB_ITEM(InfoTimeout);       // Deprecated
NXLIB_ITEM(StaticBufferSize);
NXLIB_ITEM(BacklogSize);
...
NXLIB_ITEM(BuildType);
NXLIB_VALUE(Development);
NXLIB_VALUE(Preview);

// NXLIB_ITEM(Cameras);
NXLIB_ITEM(ByEepromId);
NXLIB_ITEM(BySerialNo);
NXLIB_ITEM(Baselines);
NXLIB_ITEM(SerialNumber);
NXLIB_ITEM(Description);
...
NXLIB_ITEM(LinkLocalIpAddress);
NXLIB_ITEM(ValidFirmware);
NXLIB_ITEM(ValidCameraFirmware);
NXLIB_ITEM(ValidProjectorFirmware);
NXLIB_ITEM(IsSuppliedFirmwareVersion);
NXLIB_ITEM(IsApprovedFirmwareVersion);
NXLIB_ITEM(FirmwareSupportsModel);
NXLIB_ITEM(Paired);
...
NXLIB_ITEM(PowerOverEthernet);
NXLIB_ITEM(Heater);
NXLIB_ITEM(LocalEepromFile);
NXLIB_ITEM(LowBandwidth);
NXLIB_ITEM(ProjectorTemperatureReached);
NXLIB_ITEM(ImageFolder);
NXLIB_ITEM(Temperature);
// NXLIB_ITEM(Type);
NXLIB_ITEM(Sensor);
NXLIB_ITEM(HardwareRevision);
...
NXLIB_ITEM(FirmwareUpdateVersion);
...
NXLIB_COMMAND(UpdateDeviceList);

NXLIB_COMMAND(Retrieve);
NXLIB_ITEM(ProjectorWaitingTime);
...
NXLIB_COMMAND(CalibrateLaserProjector);
...
NXLIB_ITEM(Visible);
NXLIB_COMMAND(ProjectPoints);
NXLIB_COMMAND(ReprojectPoints);
NXLIB_ITEM(Origin);
NXLIB_ITEM(Directions);
NXLIB_COMMAND(CollectPlanePoints);
NXLIB_ITEM(PersistentOverlay);
NXLIB_COMMAND(CollectLaserPoints);
...
NXLIB_COMMAND(MeasureLaserCalibration);
NXLIB_COMMAND(QueryRenderView);
NXLIB_ITEM(Position);
NXLIB_ITEM(Object);
NXLIB_ITEM(Unknown);
NXLIB_ITEM(QueryResponse);
NXLIB_ITEM(Coordinates);
NXLIB_COMMAND(RenderView);
NXLIB_ITEM(PointCloud);
NXLIB_ITEM(UseStereoTextures); // Deprecated.
// NXLIB_ITEM(ViewPose);
...
NXLIB_COMMAND(VisualizeLaserPoints);
...
NXLIB_COMMAND(GetPresets);
NXLIB_ITEM(Condition);
NXLIB_ITEM(Extends);
NXLIB_ITEM(Hidden);
NXLIB_ITEM(IgnoreInstalled);
NXLIB_ITEM(Tags);
NXLIB_ITEM(ExcludedPresets);
NXLIB_ITEM(Presets);
NXLIB_ITEM(DataMatches);

NXLIB_ITEM(PartFinder);
NXLIB_COMMAND(PartFinder);
NXLIB_ITEM(Function);
NXLIB_ITEM(ModelPath);
NXLIB_ITEM(CompressModel);
NXLIB_VALUE(StoreModel);
NXLIB_VALUE(LoadModel);
NXLIB_VALUE(GenerateModel);
NXLIB_VALUE(GetModelDistance);
NXLIB_VALUE(DeleteModel);
NXLIB_VALUE(ListModels);
NXLIB_VALUE(Find);
NXLIB_VALUE(Confirm);
NXLIB_VALUE(GreedyObjectMatching);
NXLIB_ITEM(ModelId);
NXLIB_VALUE(LoadSupplementary);
// NXLIB_ITEM(Viewpoints);
NXLIB_ITEM(Hypothesis);
// NXLIB_ITEM(AngularResolution);
NXLIB_ITEM(CoverageScore);
NXLIB_ITEM(CombinedScore);
NXLIB_ITEM(DistanceRatio);
NXLIB_ITEM(OutputAssignments);
NXLIB_ITEM(OutputDetections);
NXLIB_ITEM(CacheSize);
NXLIB_ITEM(DisableModelGeneration);
NXLIB_ITEM(ViewpointIndex);
NXLIB_ITEM(TemplateCount);
NXLIB_ITEM(ExcludeObjects);
NXLIB_ITEM(Coverage);
NXLIB_ITEM(MaximumClusterSize);
NXLIB_ITEM(MinimumLeadingScore);
NXLIB_ITEM(RefineCombined);
NXLIB_ITEM(MinimumSpreadOrder);
NXLIB_ITEM(MaximumSpreadOrder);
NXLIB_ITEM(Refine3D);
NXLIB_ITEM(Supplementary);
NXLIB_ITEM(Find);
NXLIB_ITEM(GenerateModel);
...
NXLIB_ITEM(Projectors);
// NXLIB_ITEM(Reference);
NXLIB_ITEM(Partner);
// NXLIB_ITEM(SerialNumber);
// NXLIB_ITEM(Type);
// NXLIB_ITEM(Left);
...
NXLIB_ITEM(PreserveCalibration);
...
NXLIB_COMMAND(ComputeTexture);
NXLIB_COMMAND(Remote);
NXLIB_COMMAND(Wifi);
NXLIB_VALUE(Scan);
NXLIB_VALUE(FactoryReset);
NXLIB_VALUE(Connect);
NXLIB_VALUE(Disconnect);
NXLIB_VALUE(ClearNetwork);
NXLIB_VALUE(OpenAccessPoint);
NXLIB_VALUE(CloseAccessPoint);
NXLIB_VALUE(UpdateAccessPoint);
NXLIB_ITEM(AccessPoints);
NXLIB_COMMAND(DownloadImages);

NXLIB_COMMAND(ReadEeprom);
NXLIB_COMMAND(WriteEeprom);
NXLIB_ITEM(Data);

NXLIB_COMMAND(EstimateCaptureTimeout);
...
NXLIB_ITEM(AutoGain);
NXLIB_ITEM(MaxAutoExposureAndGainAdjustment);
...
NXLIB_ITEM(AverageTriangulationError);
NXLIB_ITEM(MaxTriangulationError);
NXLIB_ITEM(RelativeAverageTriangulationError);
NXLIB_ITEM(RelativeMaxTriangulationError);
...
NXLIB_ITEM(ShowSkybox);
NXLIB_ITEM(ShowSurface);
NXLIB_ITEM(ShowNormals);
NXLIB_ITEM(ShowCameras);
NXLIB_ITEM(ShowFieldOfView);
NXLIB_ITEM(ShowGrid);
NXLIB_ITEM(ShowOrigin);
NXLIB_ITEM(ShowUserDefinedModels);
NXLIB_ITEM(PivotPoint);
...
NXLIB_ITEM(EnforceDisparityRange);
NXLIB_ITEM(SemiGlobalMatching);
...
// NXLIB_ITEM(Method);
NXLIB_VALUE(SemiGlobalMatching);
NXLIB_ITEM(ShadowingThreshold);
NXLIB_ITEM(Padding);
NXLIB_ITEM(PropagationScheme);
NXLIB_ITEM(TiltedPatches);
NXLIB_ITEM(ValidateAgainstRightView);
NXLIB_ITEM(CoupledPropagation);
NXLIB_ITEM(Invalidation);
NXLIB_ITEM(Alpha);
NXLIB_ITEM(Beta);
NXLIB_ITEM(Smoothness);
NXLIB_ITEM(PropagationLimit);
NXLIB_ITEM(PatchMatch);
NXLIB_ITEM(PostProcessing);
NXLIB_ITEM(UniquenessRatio);
NXLIB_ITEM(UniquenessOffset);
NXLIB_ITEM(CorrespondenceThreshold);
NXLIB_ITEM(SpeckleRemoval);
NXLIB_ITEM(RegionSize);
NXLIB_ITEM(ComponentThreshold);
// NXLIB_ITEM(WindowRadius);
NXLIB_ITEM(MinimumPointRatio);
NXLIB_ITEM(Filling);
// NXLIB_ITEM(RegionSize);
...
NXLIB_ITEM(FullWidth);
NXLIB_ITEM(ScaledAreaOfInterest);
NXLIB_ITEM(ClipToAreaOfInterest);
...
// NXLIB_VALUE(X);
// NXLIB_VALUE(XPositive);
// NXLIB_VALUE(XNegative);
// NXLIB_VALUE(XRotationSymmetric);
// NXLIB_VALUE(Y);
// NXLIB_VALUE(YPositive);
// NXLIB_VALUE(YNegative);
// NXLIB_VALUE(YRotationSymmetric);
// NXLIB_VALUE(Z);
// NXLIB_VALUE(ZPositive);
// NXLIB_VALUE(ZNegative);
// NXLIB_VALUE(ZRotationSymmetric);
